...
function generateDrake() {
    ...
    const legMaterial = new THREE.MeshStandardMaterial({ color: monsterColors.drake });
...
function generateHydra() {
    ...
    const material = new THREE.MeshStandardMaterial({ color: monsterColors.hydra });
...
function generateImpling() {
    ...
    const armMaterial = new THREE.MeshStandardMaterial({ color: monsterColors.impling });
    ...
    const legMaterial = new THREE.MeshStandardMaterial({ color: monsterColors.impling });
...
function exportToGLB(model, monsterType) {
...
async function generateAllModels() {
    ...
    for (const type of monsterTypes) {
        console.log(`Generating ${type} model...`);
        
        // Generate model
        const model = monsterGenerators[type]();
        
        // Export to GLB
        await exportToGLB(model, type);
    }
    
    console.log('All monster models generated and exported!');
}
